/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: f7d7f562bb7da07f6e5638b888168444)
// Runtime types generated with workerd@1.20251125.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_SITE_URL: "https://storypot.roudan.io";
		NEXT_PUBLIC_AWS_BUCKET_NAME: "roudan-io";
		NEXT_PUBLIC_BACKEND_URL: "https://repot-cms.roudan.io";
		NEXT_PUBLIC_GA_ID: "G-HNL5EGV2TJ";
		AWS_REGION: "auto";
		HOST: "repot-cms.roudan.io";
		FIXED_CHAIN: "story";
		CRON_TOKEN: "hackquest";
		ETHERSCAN_API_BASE_URL: "https://api.etherscan.io/api";
		NEXTJS_ENV: string;
		GITHUB_OAUTH_SECRET: string;
		ETHERSCAN_API_KEY: string;
		STRAPI_API_TOKEN: string;
		STRAPI_STAR_TOKEN: string;
		STRAPI_USER_TOKEN: string;
		STRAPI_DOCUMENT_TOKEN: string;
		AWS_ACCESS_KEY_ID: string;
		AWS_SECRET_ACCESS_KEY: string;
		GOOGLE_GENAI_API_KEY: string;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		WORKER_SELF_REFERENCE: Fetcher /* repot */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_AWS_BUCKET_NAME" | "NEXT_PUBLIC_BACKEND_URL" | "NEXT_PUBLIC_GA_ID" | "AWS_REGION" | "HOST" | "FIXED_CHAIN" | "CRON_TOKEN" | "ETHERSCAN_API_BASE_URL" | "NEXTJS_ENV" | "GITHUB_OAUTH_SECRET" | "ETHERSCAN_API_KEY" | "STRAPI_API_TOKEN" | "STRAPI_STAR_TOKEN" | "STRAPI_USER_TOKEN" | "STRAPI_DOCUMENT_TOKEN" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "GOOGLE_GENAI_API_KEY">> {}
}
